...
import style from './ps-input.less';
...
class PsInput extends React.Component{
    ...
    render(){
        ...
        return(
            <div className={style['ps-text-input']} style={this.psTextInput}>
                <i style={this.headerIcon}>
                    <FontAwesomeIcon
                        icon={inputIcon}
                        className={style['header-icon']}
                    />
                </i>
                <span className={this.state.focused ? style['focused'] : ''} style={this.spanBlur}>
                    {inputPrompt}
                </span>
                <input
                    ref={this.textInput}
